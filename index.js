...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// pagination ///////////////////////////////////////////////////////////////////////////////////////////////////////////
module.exports = pages = async ({ message, pages, buttonList, timeout = 12000, m, editable, menu}) => {
   // Checks
...
*/
   ...
   if (typeof message?.author === "object") {
      ...
      // Run
      return MessagePagination(message, pages, buttonList, timeout, m, editable, menu)
   }
